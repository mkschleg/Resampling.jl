...
mutable struct TCFourRoomsContAgent{P<:Resampling.AbstractPolicy} <: JuliaRL.AbstractAgent
    ...
    function TCFourRoomsContAgent(μ::P, gvf::GVF, num_tilings, num_tiles, α_arr::Array{Float64, 1},
                                  ...
                                  warm_up, parsed, env_size; max_is_ratio=1.0, norm_is=false) where {P<:Resampling.AbstractPolicy}
...
function JuliaRL.step!(agent::TCFourRoomsContAgent, env_s_tp1, r, terminal; rng=Random.GLOBAL_RNG, kwargs...)
    ...
    experience = (create_features(agent.tilecoder, agent.state_t[1]./11.0),
                  ...
                  agent.action_t, action_tp1, c, γ, terminal, μ_prob, π_prob, (π_prob/μ_prob)./agent.max_is)
